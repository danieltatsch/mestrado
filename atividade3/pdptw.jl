...
# Conjuntos
V = 0 # conjunto de nós (vértices) do grafo direcionado completo G(V, A) que define oproblema
C = 0 # conjunto de nós de coleta
E = 0 # conjunto de nós de entrega
P = 0 # conjunto de pedidos, cada qual relacionado a um nó de coleta e um de entrega
K = 0 # conjunto de veículos disponíveis para roteamento
...
n = 0 # numero de pedidos a serem servidos
